  ...
  return (
    <div className="px-4 py-10 min-h-screen bg-gray-100 mb-10 flex flex-col items-center">
      ...
      <section className="bg-white shadow-lg mt-20 mb-10 p-6 rounded-lg gap-5 flex flex-col items-center">
        ...
        <div className="flex flex-wrap items-center gap-2 w-fit text-center">
          {/* Boutons pour appeler et envoyer un message */}
          <Link
            to={`tel:+49000000`} // Numéro allemand
            className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-800 w-fit h-10 flex-grow">
            Appeler
          </Link>
          <Link
            to={`https://wa.me/49000000000000`} // Lien WhatsApp
            className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-800 w-fit h-10 flex-grow">
            Écrire sur WhatsApp
          </Link>
          <Link
            to={`mailto:00000000000`} // Lien pour email
            className="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-800 w-fit h-10 flex-grow">
            Écrire par Email
          </Link>
        </div>
      </section>
